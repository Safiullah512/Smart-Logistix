function RecentDeliveries() {
  return (
    <div className="bg-white p-5 rounded shadow-[0_0_3px_rgba(0,0,0,0.2)] ">
      ...
      <div className="max-h-[170px] overflow-y-auto scrollbar-hide">
        <div className="flex gap-4 justify-between text-sm mt-2 items-center border-b border-slate-200 py-2">
          ...
          <p className="w-25 text-center text-blue-700 bg-blue-200 px-2 py-1 rounded ">
            In Transit
          </p>
        </div>
        <div className="flex gap-4 justify-between text-sm mt-2 items-center border-b border-slate-200 py-2">
          ...
          <p className="w-25 text-center text-green-700 bg-green-200 px-2 py-1 rounded ">
            Completed
          </p>
        </div>
        <div className="flex gap-4 justify-between text-sm mt-2 items-center border-b border-slate-200 py-2">
          ...
          <p className="w-25 text-center text-orange-700 bg-orange-200 px-2 py-1 rounded ">
            Pending
          </p>
        </div>
        <div className="flex gap-4 justify-between text-sm mt-2 items-center border-b border-slate-200 py-2">
