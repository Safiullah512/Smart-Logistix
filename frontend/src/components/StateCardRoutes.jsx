    ...
    <div className="w-full mt-3 flex gap-3">
      <div className="flex-1 min-w-0 p-4 shadow-[0_0_5px_rgba(0,0,0,0.2)] bg-white rounded-lg">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <h2 className="whitespace-nowrap">Total Routes</h2>
      ...
      <div className="flex-1 min-w-0 p-4 shadow-[0_0_5px_rgba(0,0,0,0.2)] bg-white rounded-lg">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <h2 className="whitespace-nowrap">Active Routes</h2>
      ...
      <div className="flex-1 min-w-0 p-4 shadow-[0_0_5px_rgba(0,0,0,0.2)] bg-white rounded-lg">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <h2 className="whitespace-nowrap">Average Delivery Time</h2>
      ...
      <div className="flex-1 min-w-0 p-4 shadow-[0_0_5px_rgba(0,0,0,0.2)] bg-white rounded-lg">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <h2 className="whitespace-nowrap">On-TIme Delivery</h2>
            <h1 className="font-bold text-2xl">120</h1>
          </div>
        </div>
...
export default StateCardRoutes;
