...
export default function PersonalInformation() {
  ...
  return (
    ...
    >
      <InputField label="Full Name" value={form.fullName} onChange={update("fullName")} />
      <InputField label="Email Address" value={form.email} onChange={update("email")} type="email" />
