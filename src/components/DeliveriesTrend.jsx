...
function DeliveriesTrend() {
  return (
    <div className="w-100 bg-white p-3 rounded shadow-[0_0_3px_rgba(0,0,0,0.3)]">
      <div className="flex justify-between mb-4">
        <p className="font-bold">Deliveries Trend</p>
...
export default DeliveriesTrend;
